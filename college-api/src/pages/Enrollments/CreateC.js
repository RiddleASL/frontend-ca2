                                ...
                                <form>
                                    ...
                                    <div className="form-control">
                                        <label className="label">
                                            ...
                                            {errors.course_id && <span className="text-sm text-error">{errors.course_id[0]}</span>}
                                        </label> 
                                        <select className="select select-bordered w-full" onChange={(e) => setCourse(e.target.value)}>
